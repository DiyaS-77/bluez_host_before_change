...
class BluetoothUIApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.bluetooth_device_manager = BluetoothDeviceManager(capability="NoInputNoOutput",log_path=self.log_path)
        self.scroll = None
    ...
    def list_controllers(self):
        ...
        self.add_items(
            ...
            list(self.bluetooth_device_manager.get_controllers_connected().keys()),
    ...
    def controller_selected(self, address):
        ...
        self.bluetooth_device_manager.bd_address = controller

        if controller in self.bluetooth_device_manager.controllers_list:
            self.bluetooth_device_manager.interface=self.bluetooth_device_manager.controllers_list[controller]
        run(self.log, f"hciconfig -a {self.bluetooth_device_manager.interface} up")
        self.bluetooth_device_manager.initialize_adapter(interface=self.bluetooth_device_manager.interface)
        ...
        item = QListWidgetItem(self.bluetooth_device_manager.get_controller_interface_details())
    ...
    def check_controller_selected(self):
        ...
        returns: None
        """
        if self.bluetooth_device_manager.bd_address:
            self.setWindowTitle('Test Controller')
            self.setCentralWidget(TestControllerUI(self.bluetooth_device_manager, self.show_main))
    ...
    def test_application_clicked(self):
        ...
        self.setCentralWidget(TestApplication(bluetooth_device_manager=self.bluetooth_device_manager,interface=self.bluetooth_device_manager.interface,
